...
public static class CreateProductHandlerTestData
{
    ...
    public static CreateProductCommand GenerateValidCommand() => commandFaker.Generate();

    public static Product GenerateProductFromCommand(CreateProductCommand command, int id = 123)
    {
